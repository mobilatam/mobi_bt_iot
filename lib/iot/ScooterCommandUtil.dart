...
import 'package:mobi_bt_iot/iot/base_command.dart';
...
class ScooterCommandUtil extends BaseCommand {
  ...
  static List<int> getCRCCommunicationKey(String deviceKey) {
  ...
  static List<int> getCRCScooterClose(int ckey) {
    List<int> data = [0x01];
    List<int> command = getCommand(
      ckey,
  ...
  static List<int> getCRCScooterCloseResponse(int ckey) {
    List<int> data = [0x02];
    List<int> command = getCommand(
      ckey,
      CommandType.scooterClose,
  ...
  static List<int> getCRCShutDown(int cKey, int opt) {
    List<int> data = [0, opt];
    List<int> command = getCommand(
      cKey,
      CommandType.config,
  ...
  static List<int> getCRCScooterIotInfo(int ckey) {
    List<int> data = [0x01];
    List<int> command = getCommand(
      ckey,
  ...
  static List<int> getCRCScooterInfo(int ckey) {
    List<int> data = [0x01];
    List<int> command = getCommand(
      ckey,
  ...
  static List<int> getCRCGetOldData(int cKey) {
    List<int> data = [0x01];
    List<int> command = getCommand(
      cKey,
      CommandType.oldData,
  ...
  static List<int> getCRCClearOldData(int cKey) {
    List<int> data = [0x01];
    List<int> command = getCommand(
      cKey,
